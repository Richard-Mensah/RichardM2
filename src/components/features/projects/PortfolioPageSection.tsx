...
export default function PortfolioPageSection({ repos }: Props) {
  return (
    <div>
      {/* Hero */}
      <section className="relative overflow-hidden bg-[#14001a] px-5 py-20 md:px-8 md:py-28">
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-3 text-xs font-black text-white/60">
            ...
            <div className="relative h-72 overflow-hidden rounded-2xl lg:h-96">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#14001a]/50 to-transparent" />
            </div>
          </div>
        </div>
      </section>
