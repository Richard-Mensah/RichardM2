  ...
  return (
    <div className="research-ground relative px-5 py-20 md:px-8">
      ...
      <div className="relative mx-auto max-w-5xl">
        ...
        {/* Hero */}
        <p className="text-xs font-black uppercase tracking-[0.32em] text-accent-strong">AI & Data Science</p>
        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-2">
          <div>
            <p className="text-xs font-black uppercase tracking-[0.28em] text-accent-strong">Core research focus</p>
          ...
          <div>
            <p className="text-xs font-black uppercase tracking-[0.28em] text-accent-strong">Research to deployment</p>
            <h2 className="mt-4 text-2xl font-black tracking-[-0.03em] text-ink">
        ...
        {/* Systems teasers */}
        <div className="mt-12">
          <p className="text-xs font-black uppercase tracking-[0.28em] text-muted">Featured systems</p>
          <div className="mt-5 grid gap-5 md:grid-cols-2">
            {featuredSystems.map((sys) => (
              ...
              >
                ...
                <h3 className="mt-4 text-base font-black text-ink">{sys.title}</h3>
                <p className="mt-2 text-xs leading-5 text-muted">{sys.approach}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mt-12 rounded-2xl bg-transparent p-8">
          <p className="text-sm font-black uppercase tracking-[0.22em] text-accent-strong">Work together</p>
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            <Link href="/systems" className="btn-primary rounded-full px-6 py-2.5 text-sm font-black">
              Explore AI systems
            </Link>
