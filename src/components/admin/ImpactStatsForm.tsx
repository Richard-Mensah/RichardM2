      ...
      {stats.map((stat, i) => (
        <div key={i} className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-[140px_1fr]">
            <div>
              <label className="mb-1.5 block text-sm font-semibold text-slate-700">Value *</label>
              <input
                value={stat.value}
          ...
          <div className="mt-4">
            <label className="mb-1.5 block text-sm font-semibold text-slate-700">
              Detail <span className="font-normal text-slate-400">(shown on the homepage)</span>
            </label>
            <textarea
              value={stat.detail}
