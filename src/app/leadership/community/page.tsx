...
const SDG_TAGS = [
  ...
  { code: "SDG 3", label: "Good Health & Wellbeing", color: "#2f6bea" },
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="mx-auto max-w-6xl px-5 pb-24 pt-16 md:px-8">
        ...
        <div className="mt-20">
          <div className="flex items-center gap-3">
            <span className="grid h-8 w-8 place-items-center rounded-full bg-[#2f6bea] text-xs font-black text-white">3</span>
            <p className="text-xs font-black uppercase tracking-[0.25em] text-[#2f6bea]">
