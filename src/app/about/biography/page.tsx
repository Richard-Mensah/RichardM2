    ...
    <div className="flex min-h-[calc(100vh-5rem)] flex-col">
      ...
      <section className="bg-[#0B1F3A] px-5 py-16 md:px-8 md:py-24">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="text-xs font-black uppercase tracking-[0.3em] text-[#62E8FF]">Biography</p>
      ...
      <section className="bg-white px-5 py-16 md:px-8 md:py-24">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-14 lg:grid-cols-[1fr_0.75fr] lg:items-start">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.3em] text-[#0077FF]">Full Biography</p>
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-start gap-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              ...
              className="whitespace-nowrap rounded-full bg-white px-5 py-2.5 text-xs font-black uppercase tracking-[0.15em] text-[#0077FF] transition hover:bg-slate-100"
            >
              Leadership Journey
            </Link>
            <Link
