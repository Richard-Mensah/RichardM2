...
export const DEFAULT_TESTIMONIALS: Testimonial[] = [
  { name: "Ama Osei", role: "Women in Data Ghana participant", initials: "AO", accent: "#3a78e0", quote: "I came in not knowing how to apply for a fellowship. Richard sat with me, went through every section of the application, and helped me write a personal statement I was actually proud of. I got in. I still cannot believe it." },
  { name: "Samuel Nkrumah", role: "Youth Network Lead", initials: "SN", accent: "#2f6bea", quote: "Our community climate programme was struggling. Richard helped us redesign the structure, train our volunteers and measure outcomes properly. Within four months we had reached 120 young people. The change was night and day." },
  { name: "Amina Yusuf", role: "AI and Climate Change fellow", initials: "AY", accent: "#4f8bff", quote: "I had heard a lot about AI but had no idea where to start. The sessions with Richard were practical from day one. By the end my team had built a weather dashboard that actual farmers in our district were using." },
  { name: "Kweku Asante", role: "Digital skills trainee", initials: "KA", accent: "#4f8bff", quote: "Before the programme I could not confidently use a spreadsheet. Twelve weeks later I was presenting a data dashboard to my entire department. Richard made it feel achievable at every step." },
...
async function ensureTable(): Promise<void> {
  ...
  await pool.query(`
    CREATE TABLE IF NOT EXISTS testimonials (
      ...
      accent varchar(16) NOT NULL DEFAULT '#4f8bff'
    );
  `);
  tableReady = true;
}
